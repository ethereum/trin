...
# based on https://github.com/paradigmxyz/reth/blob/a505f4914780c9ec6d1ca4ae1182244b851b89a7/book/cli/help.rs
...
fn preprocess_help(s: &str) -> Cow<'_, str> {
    static REPLACEMENTS: LazyLock<Vec<(Regex, &str)>> = LazyLock::new(|| {
        let patterns: &[(&str, &str)] = &[
            ...
            (r"default: /.*/trin", "default: <CACHE_DIR>"),
...
struct Cmd<'a> {
    /// path to binary (e.g. ./target/debug/trin)
    cmd: &'a Path,

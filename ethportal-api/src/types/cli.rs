...
#[command(name = APP_NAME,
    ...
    // We can't use trin_utils::version here to get the version, since it's a local dependency
    // which prevents publishing ethportal-api. There's also not a non-hacky way to house
    // those versioning utils inside ethportal-api.

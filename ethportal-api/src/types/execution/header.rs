...
impl ssz::Decode for HeaderWithProof {
    ...
    fn from_ssz_bytes(bytes: &[u8]) -> Result<Self, ssz::DecodeError> {
        ...
        let header: Header = Header::decode(&mut header_rlp.as_slice()).map_err(|_| {
...
mod tests {
    ...
    fn decode_and_encode_header() {
        ...
        let header: Header =
            Header::decode(&mut header_rlp.as_slice()).expect("error decoding header");
    ...
    fn decode_and_encode_header_after_1559() {
        ...
        let header: Header = Header::decode(&mut header_rlp.as_slice()).unwrap();
    ...
    fn dencun_rlp_ethereum_tests_example() {
        ...
        let decoded: Header = Header::decode(&mut data.as_slice()).unwrap();

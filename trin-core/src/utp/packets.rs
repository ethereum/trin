...
fn check_extensions(data: &[u8]) -> anyhow::Result<()> {
...
mod tests {
    ...
    fn test_syn_packet() {
        ...
        packet.set_timestamp(Timestamp(3384187322));
        packet.set_timestamp_difference(Delay(0));
    ...
    fn test_act_packet_no_extension() {
        ...
        packet.set_type(PacketType::State);
        packet.set_connection_id(10049);
        packet.set_timestamp(Timestamp(6195294));
        packet.set_timestamp_difference(Delay(916973699));
        packet.set_wnd_size(1048576);
    ...
    fn test_data_packet() {
        ...
        packet.set_timestamp(Timestamp(252492495));
        packet.set_timestamp_difference(Delay(242289855));
        packet.set_wnd_size(1048576);
    ...
    fn test_fin_packet() {
        ...
        packet.set_timestamp(Timestamp(515227279));
        packet.set_timestamp_difference(Delay(511481041));
        packet.set_wnd_size(1048576);
    ...
    fn test_reset_packet() {
        ...
        packet.set_timestamp(Timestamp(751226811));
        packet.set_timestamp_difference(Delay(0));
